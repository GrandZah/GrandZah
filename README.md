...
- **Vologda Murals Map** — интерактивная карта муралов Вологды: каталог муралов/художников + координаты + карточки с фото, статический деплой.
  Proof: [VologdaMuralsMap](https://vologda-murals-map.s3-website.cloud.ru/)
